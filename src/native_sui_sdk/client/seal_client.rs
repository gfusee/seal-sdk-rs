...
pub mod moka {
    ...
    impl SealClientMokaCache {
        pub fn new(
            sui_client: sui_sdk::SuiClient,
            key_server_cache_builder: CacheBuilder<KeyServerInfoCacheKey, KeyServerInfo, Cache<KeyServerInfoCacheKey, KeyServerInfo>>,
            derived_keys_cache_builder: CacheBuilder<DerivedKeyCacheKey, Vec<DerivedKeys>, Cache<DerivedKeyCacheKey, Vec<DerivedKeys>>>,
        ) -> SealClientMokaCache {
            BaseSealClient::new_custom(
